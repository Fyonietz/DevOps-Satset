...
pub const struct_ssh_counter_struct = extern struct {
    in_bytes: u64 = @import("std").mem.zeroes(u64),
    out_bytes: u64 = @import("std").mem.zeroes(u64),
    in_packets: u64 = @import("std").mem.zeroes(u64),
    out_packets: u64 = @import("std").mem.zeroes(u64),
};
pub const ssh_counter = [*c]struct_ssh_counter_struct;
pub const struct_ssh_agent_struct = opaque {};
pub const ssh_agent = ?*struct_ssh_agent_struct;
pub const struct_ssh_buffer_struct = opaque {};
pub const ssh_buffer = ?*struct_ssh_buffer_struct;
pub const struct_ssh_channel_struct = opaque {};
pub const ssh_channel = ?*struct_ssh_channel_struct;
pub const struct_ssh_message_struct = opaque {};
pub const ssh_message = ?*struct_ssh_message_struct;
pub const struct_ssh_pcap_file_struct = opaque {};
pub const ssh_pcap_file = ?*struct_ssh_pcap_file_struct;
pub const struct_ssh_key_struct = opaque {};
pub const ssh_key = ?*struct_ssh_key_struct;
pub const struct_ssh_scp_struct = opaque {};
pub const ssh_scp = ?*struct_ssh_scp_struct;
pub const struct_ssh_session_struct = opaque {};
pub const ssh_session = ?*struct_ssh_session_struct;
pub const struct_ssh_string_struct = opaque {};
pub const ssh_string = ?*struct_ssh_string_struct;
pub const struct_ssh_event_struct = opaque {};
pub const ssh_event = ?*struct_ssh_event_struct;
pub const struct_ssh_connector_struct = opaque {};
pub const ssh_connector = ?*struct_ssh_connector_struct;
pub const ssh_gssapi_creds = ?*anyopaque;
pub const socket_t = c_int;
pub const SSH_KEX: c_int = 0;
pub const SSH_HOSTKEYS: c_int = 1;
pub const SSH_CRYPT_C_S: c_int = 2;
pub const SSH_CRYPT_S_C: c_int = 3;
pub const SSH_MAC_C_S: c_int = 4;
pub const SSH_MAC_S_C: c_int = 5;
pub const SSH_COMP_C_S: c_int = 6;
pub const SSH_COMP_S_C: c_int = 7;
pub const SSH_LANG_C_S: c_int = 8;
pub const SSH_LANG_S_C: c_int = 9;
pub const enum_ssh_kex_types_e = c_uint;
pub const SSH_AUTH_SUCCESS: c_int = 0;
pub const SSH_AUTH_DENIED: c_int = 1;
pub const SSH_AUTH_PARTIAL: c_int = 2;
pub const SSH_AUTH_INFO: c_int = 3;
pub const SSH_AUTH_AGAIN: c_int = 4;
pub const SSH_AUTH_ERROR: c_int = -1;
pub const enum_ssh_auth_e = c_int;
pub const SSH_REQUEST_AUTH: c_int = 1;
pub const SSH_REQUEST_CHANNEL_OPEN: c_int = 2;
pub const SSH_REQUEST_CHANNEL: c_int = 3;
pub const SSH_REQUEST_SERVICE: c_int = 4;
pub const SSH_REQUEST_GLOBAL: c_int = 5;
pub const enum_ssh_requests_e = c_uint;
pub const SSH_CHANNEL_UNKNOWN: c_int = 0;
pub const SSH_CHANNEL_SESSION: c_int = 1;
pub const SSH_CHANNEL_DIRECT_TCPIP: c_int = 2;
pub const SSH_CHANNEL_FORWARDED_TCPIP: c_int = 3;
pub const SSH_CHANNEL_X11: c_int = 4;
pub const SSH_CHANNEL_AUTH_AGENT: c_int = 5;
pub const enum_ssh_channel_type_e = c_uint;
pub const SSH_CHANNEL_REQUEST_UNKNOWN: c_int = 0;
pub const SSH_CHANNEL_REQUEST_PTY: c_int = 1;
pub const SSH_CHANNEL_REQUEST_EXEC: c_int = 2;
pub const SSH_CHANNEL_REQUEST_SHELL: c_int = 3;
pub const SSH_CHANNEL_REQUEST_ENV: c_int = 4;
pub const SSH_CHANNEL_REQUEST_SUBSYSTEM: c_int = 5;
pub const SSH_CHANNEL_REQUEST_WINDOW_CHANGE: c_int = 6;
pub const SSH_CHANNEL_REQUEST_X11: c_int = 7;
pub const enum_ssh_channel_requests_e = c_uint;
pub const SSH_GLOBAL_REQUEST_UNKNOWN: c_int = 0;
pub const SSH_GLOBAL_REQUEST_TCPIP_FORWARD: c_int = 1;
pub const SSH_GLOBAL_REQUEST_CANCEL_TCPIP_FORWARD: c_int = 2;
pub const SSH_GLOBAL_REQUEST_KEEPALIVE: c_int = 3;
pub const SSH_GLOBAL_REQUEST_NO_MORE_SESSIONS: c_int = 4;
pub const enum_ssh_global_requests_e = c_uint;
pub const SSH_PUBLICKEY_STATE_ERROR: c_int = -1;
pub const SSH_PUBLICKEY_STATE_NONE: c_int = 0;
pub const SSH_PUBLICKEY_STATE_VALID: c_int = 1;
pub const SSH_PUBLICKEY_STATE_WRONG: c_int = 2;
pub const enum_ssh_publickey_state_e = c_int;
pub const SSH_SERVER_ERROR: c_int = -1;
pub const SSH_SERVER_NOT_KNOWN: c_int = 0;
pub const SSH_SERVER_KNOWN_OK: c_int = 1;
pub const SSH_SERVER_KNOWN_CHANGED: c_int = 2;
pub const SSH_SERVER_FOUND_OTHER: c_int = 3;
pub const SSH_SERVER_FILE_NOT_FOUND: c_int = 4;
pub const enum_ssh_server_known_e = c_int;
pub const SSH_KNOWN_HOSTS_ERROR: c_int = -2;
pub const SSH_KNOWN_HOSTS_NOT_FOUND: c_int = -1;
pub const SSH_KNOWN_HOSTS_UNKNOWN: c_int = 0;
pub const SSH_KNOWN_HOSTS_OK: c_int = 1;
pub const SSH_KNOWN_HOSTS_CHANGED: c_int = 2;
pub const SSH_KNOWN_HOSTS_OTHER: c_int = 3;
pub const enum_ssh_known_hosts_e = c_int;
pub const SSH_NO_ERROR: c_int = 0;
pub const SSH_REQUEST_DENIED: c_int = 1;
pub const SSH_FATAL: c_int = 2;
pub const SSH_EINTR: c_int = 3;
pub const enum_ssh_error_types_e = c_uint;
...
pub const SSH_KEYTYPE_DSS_CERT01: c_int = 6;
pub const SSH_KEYTYPE_RSA_CERT01: c_int = 7;
...
pub const SSH_KEYTYPE_ECDSA_P256_CERT01: c_int = 11;
pub const SSH_KEYTYPE_ECDSA_P384_CERT01: c_int = 12;
pub const SSH_KEYTYPE_ECDSA_P521_CERT01: c_int = 13;
pub const SSH_KEYTYPE_ED25519_CERT01: c_int = 14;
pub const SSH_KEYTYPE_SK_ECDSA: c_int = 15;
pub const SSH_KEYTYPE_SK_ECDSA_CERT01: c_int = 16;
pub const SSH_KEYTYPE_SK_ED25519: c_int = 17;
pub const SSH_KEYTYPE_SK_ED25519_CERT01: c_int = 18;
pub const enum_ssh_keytypes_e = c_uint;
pub const SSH_KEY_CMP_PUBLIC: c_int = 0;
pub const SSH_KEY_CMP_PRIVATE: c_int = 1;
pub const SSH_KEY_CMP_CERTIFICATE: c_int = 2;
pub const enum_ssh_keycmp_e = c_uint;
pub const struct_ssh_knownhosts_entry = extern struct {
    hostname: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    unparsed: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    publickey: ssh_key = @import("std").mem.zeroes(ssh_key),
...
pub const SSH_CONTROL_MASTER_NO: c_int = 0;
pub const SSH_CONTROL_MASTER_AUTO: c_int = 1;
pub const SSH_CONTROL_MASTER_YES: c_int = 2;
pub const SSH_CONTROL_MASTER_ASK: c_int = 3;
pub const SSH_CONTROL_MASTER_AUTOASK: c_int = 4;
pub const enum_ssh_control_master_options_e = c_uint;
pub const SSH_OPTIONS_HOST: c_int = 0;
pub const SSH_OPTIONS_PORT: c_int = 1;
pub const SSH_OPTIONS_PORT_STR: c_int = 2;
pub const SSH_OPTIONS_FD: c_int = 3;
pub const SSH_OPTIONS_USER: c_int = 4;
pub const SSH_OPTIONS_SSH_DIR: c_int = 5;
pub const SSH_OPTIONS_IDENTITY: c_int = 6;
pub const SSH_OPTIONS_ADD_IDENTITY: c_int = 7;
pub const SSH_OPTIONS_KNOWNHOSTS: c_int = 8;
pub const SSH_OPTIONS_TIMEOUT: c_int = 9;
pub const SSH_OPTIONS_TIMEOUT_USEC: c_int = 10;
pub const SSH_OPTIONS_SSH1: c_int = 11;
pub const SSH_OPTIONS_SSH2: c_int = 12;
pub const SSH_OPTIONS_LOG_VERBOSITY: c_int = 13;
pub const SSH_OPTIONS_LOG_VERBOSITY_STR: c_int = 14;
pub const SSH_OPTIONS_CIPHERS_C_S: c_int = 15;
pub const SSH_OPTIONS_CIPHERS_S_C: c_int = 16;
pub const SSH_OPTIONS_COMPRESSION_C_S: c_int = 17;
pub const SSH_OPTIONS_COMPRESSION_S_C: c_int = 18;
pub const SSH_OPTIONS_PROXYCOMMAND: c_int = 19;
pub const SSH_OPTIONS_BINDADDR: c_int = 20;
pub const SSH_OPTIONS_STRICTHOSTKEYCHECK: c_int = 21;
pub const SSH_OPTIONS_COMPRESSION: c_int = 22;
pub const SSH_OPTIONS_COMPRESSION_LEVEL: c_int = 23;
pub const SSH_OPTIONS_KEY_EXCHANGE: c_int = 24;
pub const SSH_OPTIONS_HOSTKEYS: c_int = 25;
pub const SSH_OPTIONS_GSSAPI_SERVER_IDENTITY: c_int = 26;
pub const SSH_OPTIONS_GSSAPI_CLIENT_IDENTITY: c_int = 27;
pub const SSH_OPTIONS_GSSAPI_DELEGATE_CREDENTIALS: c_int = 28;
pub const SSH_OPTIONS_HMAC_C_S: c_int = 29;
pub const SSH_OPTIONS_HMAC_S_C: c_int = 30;
pub const SSH_OPTIONS_PASSWORD_AUTH: c_int = 31;
pub const SSH_OPTIONS_PUBKEY_AUTH: c_int = 32;
pub const SSH_OPTIONS_KBDINT_AUTH: c_int = 33;
pub const SSH_OPTIONS_GSSAPI_AUTH: c_int = 34;
pub const SSH_OPTIONS_GLOBAL_KNOWNHOSTS: c_int = 35;
pub const SSH_OPTIONS_NODELAY: c_int = 36;
pub const SSH_OPTIONS_PUBLICKEY_ACCEPTED_TYPES: c_int = 37;
pub const SSH_OPTIONS_PROCESS_CONFIG: c_int = 38;
pub const SSH_OPTIONS_REKEY_DATA: c_int = 39;
pub const SSH_OPTIONS_REKEY_TIME: c_int = 40;
pub const SSH_OPTIONS_RSA_MIN_SIZE: c_int = 41;
pub const SSH_OPTIONS_IDENTITY_AGENT: c_int = 42;
pub const SSH_OPTIONS_IDENTITIES_ONLY: c_int = 43;
pub const SSH_OPTIONS_CONTROL_MASTER: c_int = 44;
pub const SSH_OPTIONS_CONTROL_PATH: c_int = 45;
pub const SSH_OPTIONS_CERTIFICATE: c_int = 46;
pub const SSH_OPTIONS_PROXYJUMP: c_int = 47;
pub const SSH_OPTIONS_PROXYJUMP_CB_LIST_APPEND: c_int = 48;
pub const enum_ssh_options_e = c_uint;
pub const SSH_SCP_WRITE: c_int = 0;
pub const SSH_SCP_READ: c_int = 1;
pub const SSH_SCP_RECURSIVE: c_int = 16;
const enum_unnamed_14 = c_uint;
pub const SSH_SCP_REQUEST_NEWDIR: c_int = 1;
pub const SSH_SCP_REQUEST_NEWFILE: c_int = 2;
pub const SSH_SCP_REQUEST_EOF: c_int = 3;
pub const SSH_SCP_REQUEST_ENDDIR: c_int = 4;
pub const SSH_SCP_REQUEST_WARNING: c_int = 5;
pub const enum_ssh_scp_request_types = c_uint;
pub const SSH_CONNECTOR_STDOUT: c_int = 1;
pub const SSH_CONNECTOR_STDINOUT: c_int = 1;
pub const SSH_CONNECTOR_STDERR: c_int = 2;
pub const SSH_CONNECTOR_BOTH: c_int = 3;
pub const enum_ssh_connector_flags_e = c_uint;
pub extern fn ssh_blocking_flush(session: ssh_session, timeout: c_int) c_int;
pub extern fn ssh_channel_accept_x11(channel: ssh_channel, timeout_ms: c_int) ssh_channel;
pub extern fn ssh_channel_change_pty_size(channel: ssh_channel, cols: c_int, rows: c_int) c_int;
pub extern fn ssh_channel_close(channel: ssh_channel) c_int;
pub extern fn ssh_channel_free(channel: ssh_channel) void;
pub extern fn ssh_channel_get_exit_state(channel: ssh_channel, pexit_code: [*c]u32, pexit_signal: [*c][*c]u8, pcore_dumped: [*c]c_int) c_int;
pub extern fn ssh_channel_get_exit_status(channel: ssh_channel) c_int;
pub extern fn ssh_channel_get_session(channel: ssh_channel) ssh_session;
pub extern fn ssh_channel_is_closed(channel: ssh_channel) c_int;
pub extern fn ssh_channel_is_eof(channel: ssh_channel) c_int;
pub extern fn ssh_channel_is_open(channel: ssh_channel) c_int;
pub extern fn ssh_channel_new(session: ssh_session) ssh_channel;
pub extern fn ssh_channel_open_auth_agent(channel: ssh_channel) c_int;
pub extern fn ssh_channel_open_forward(channel: ssh_channel, remotehost: [*c]const u8, remoteport: c_int, sourcehost: [*c]const u8, localport: c_int) c_int;
pub extern fn ssh_channel_open_forward_unix(channel: ssh_channel, remotepath: [*c]const u8, sourcehost: [*c]const u8, localport: c_int) c_int;
pub extern fn ssh_channel_open_session(channel: ssh_channel) c_int;
pub extern fn ssh_channel_open_x11(channel: ssh_channel, orig_addr: [*c]const u8, orig_port: c_int) c_int;
pub extern fn ssh_channel_poll(channel: ssh_channel, is_stderr: c_int) c_int;
pub extern fn ssh_channel_poll_timeout(channel: ssh_channel, timeout: c_int, is_stderr: c_int) c_int;
pub extern fn ssh_channel_read(channel: ssh_channel, dest: ?*anyopaque, count: u32, is_stderr: c_int) c_int;
pub extern fn ssh_channel_read_timeout(channel: ssh_channel, dest: ?*anyopaque, count: u32, is_stderr: c_int, timeout_ms: c_int) c_int;
pub extern fn ssh_channel_read_nonblocking(channel: ssh_channel, dest: ?*anyopaque, count: u32, is_stderr: c_int) c_int;
pub extern fn ssh_channel_request_env(channel: ssh_channel, name: [*c]const u8, value: [*c]const u8) c_int;
pub extern fn ssh_channel_request_exec(channel: ssh_channel, cmd: [*c]const u8) c_int;
pub extern fn ssh_channel_request_pty(channel: ssh_channel) c_int;
pub extern fn ssh_channel_request_pty_size(channel: ssh_channel, term: [*c]const u8, cols: c_int, rows: c_int) c_int;
pub extern fn ssh_channel_request_pty_size_modes(channel: ssh_channel, term: [*c]const u8, cols: c_int, rows: c_int, modes: [*c]const u8, modes_len: usize) c_int;
pub extern fn ssh_channel_request_shell(channel: ssh_channel) c_int;
pub extern fn ssh_channel_request_send_signal(channel: ssh_channel, signum: [*c]const u8) c_int;
pub extern fn ssh_channel_request_send_break(channel: ssh_channel, length: u32) c_int;
pub extern fn ssh_channel_request_sftp(channel: ssh_channel) c_int;
pub extern fn ssh_channel_request_subsystem(channel: ssh_channel, subsystem: [*c]const u8) c_int;
pub extern fn ssh_channel_request_x11(channel: ssh_channel, single_connection: c_int, protocol: [*c]const u8, cookie: [*c]const u8, screen_number: c_int) c_int;
pub extern fn ssh_channel_request_auth_agent(channel: ssh_channel) c_int;
pub extern fn ssh_channel_send_eof(channel: ssh_channel) c_int;
pub extern fn ssh_channel_set_blocking(channel: ssh_channel, blocking: c_int) void;
pub extern fn ssh_channel_set_counter(channel: ssh_channel, counter: ssh_counter) void;
pub extern fn ssh_channel_write(channel: ssh_channel, data: ?*const anyopaque, len: u32) c_int;
pub extern fn ssh_channel_write_stderr(channel: ssh_channel, data: ?*const anyopaque, len: u32) c_int;
pub extern fn ssh_channel_window_size(channel: ssh_channel) u32;
pub extern fn ssh_basename(path: [*c]const u8) [*c]u8;
pub extern fn ssh_clean_pubkey_hash(hash: [*c][*c]u8) void;
pub extern fn ssh_connect(session: ssh_session) c_int;
pub extern fn ssh_connector_new(session: ssh_session) ssh_connector;
pub extern fn ssh_connector_free(connector: ssh_connector) void;
pub extern fn ssh_connector_set_in_channel(connector: ssh_connector, channel: ssh_channel, flags: enum_ssh_connector_flags_e) c_int;
pub extern fn ssh_connector_set_out_channel(connector: ssh_connector, channel: ssh_channel, flags: enum_ssh_connector_flags_e) c_int;
pub extern fn ssh_connector_set_in_fd(connector: ssh_connector, fd: socket_t) void;
pub extern fn ssh_connector_set_out_fd(connector: ssh_connector, fd: socket_t) void;
pub extern fn ssh_copyright() [*c]const u8;
pub extern fn ssh_disconnect(session: ssh_session) void;
pub extern fn ssh_dirname(path: [*c]const u8) [*c]u8;
pub extern fn ssh_finalize() c_int;
pub extern fn ssh_channel_open_forward_port(session: ssh_session, timeout_ms: c_int, destination_port: [*c]c_int, originator: [*c][*c]u8, originator_port: [*c]c_int) ssh_channel;
pub extern fn ssh_channel_accept_forward(session: ssh_session, timeout_ms: c_int, destination_port: [*c]c_int) ssh_channel;
pub extern fn ssh_channel_cancel_forward(session: ssh_session, address: [*c]const u8, port: c_int) c_int;
pub extern fn ssh_channel_listen_forward(session: ssh_session, address: [*c]const u8, port: c_int, bound_port: [*c]c_int) c_int;
pub extern fn ssh_free(session: ssh_session) void;
pub extern fn ssh_get_disconnect_message(session: ssh_session) [*c]const u8;
pub extern fn ssh_get_error(@"error": ?*anyopaque) [*c]const u8;
pub extern fn ssh_get_error_code(@"error": ?*anyopaque) c_int;
pub extern fn ssh_get_fd(session: ssh_session) socket_t;
pub extern fn ssh_get_hexa(what: [*c]const u8, len: usize) [*c]u8;
pub extern fn ssh_get_issue_banner(session: ssh_session) [*c]u8;
pub extern fn ssh_get_openssh_version(session: ssh_session) c_int;
pub extern fn ssh_request_no_more_sessions(session: ssh_session) c_int;
pub extern fn ssh_get_server_publickey(session: ssh_session, key: [*c]ssh_key) c_int;
pub const SSH_PUBLICKEY_HASH_SHA1: c_int = 0;
pub const SSH_PUBLICKEY_HASH_MD5: c_int = 1;
pub const SSH_PUBLICKEY_HASH_SHA256: c_int = 2;
pub const enum_ssh_publickey_hash_type = c_uint;
pub extern fn ssh_get_publickey_hash(key: ssh_key, @"type": enum_ssh_publickey_hash_type, hash: [*c][*c]u8, hlen: [*c]usize) c_int;
pub extern fn ssh_get_pubkey_hash(session: ssh_session, hash: [*c][*c]u8) c_int;
pub extern fn ssh_forward_accept(session: ssh_session, timeout_ms: c_int) ssh_channel;
pub extern fn ssh_forward_cancel(session: ssh_session, address: [*c]const u8, port: c_int) c_int;
pub extern fn ssh_forward_listen(session: ssh_session, address: [*c]const u8, port: c_int, bound_port: [*c]c_int) c_int;
pub extern fn ssh_get_publickey(session: ssh_session, key: [*c]ssh_key) c_int;
pub extern fn ssh_write_knownhost(session: ssh_session) c_int;
pub extern fn ssh_dump_knownhost(session: ssh_session) [*c]u8;
pub extern fn ssh_is_server_known(session: ssh_session) c_int;
pub extern fn ssh_print_hexa(descr: [*c]const u8, what: [*c]const u8, len: usize) void;
pub extern fn ssh_channel_select(readchans: [*c]ssh_channel, writechans: [*c]ssh_channel, exceptchans: [*c]ssh_channel, timeout: [*c]struct_timeval) c_int;
pub extern fn ssh_scp_accept_request(scp: ssh_scp) c_int;
pub extern fn ssh_scp_close(scp: ssh_scp) c_int;
pub extern fn ssh_scp_deny_request(scp: ssh_scp, reason: [*c]const u8) c_int;
pub extern fn ssh_scp_free(scp: ssh_scp) void;
pub extern fn ssh_scp_init(scp: ssh_scp) c_int;
pub extern fn ssh_scp_leave_directory(scp: ssh_scp) c_int;
pub extern fn ssh_scp_new(session: ssh_session, mode: c_int, location: [*c]const u8) ssh_scp;
pub extern fn ssh_scp_pull_request(scp: ssh_scp) c_int;
pub extern fn ssh_scp_push_directory(scp: ssh_scp, dirname: [*c]const u8, mode: c_int) c_int;
pub extern fn ssh_scp_push_file(scp: ssh_scp, filename: [*c]const u8, size: usize, perms: c_int) c_int;
pub extern fn ssh_scp_push_file64(scp: ssh_scp, filename: [*c]const u8, size: u64, perms: c_int) c_int;
pub extern fn ssh_scp_read(scp: ssh_scp, buffer: ?*anyopaque, size: usize) c_int;
pub extern fn ssh_scp_request_get_filename(scp: ssh_scp) [*c]const u8;
pub extern fn ssh_scp_request_get_permissions(scp: ssh_scp) c_int;
pub extern fn ssh_scp_request_get_size(scp: ssh_scp) usize;
pub extern fn ssh_scp_request_get_size64(scp: ssh_scp) u64;
pub extern fn ssh_scp_request_get_warning(scp: ssh_scp) [*c]const u8;
pub extern fn ssh_scp_write(scp: ssh_scp, buffer: ?*const anyopaque, len: usize) c_int;
pub extern fn ssh_get_random(where: ?*anyopaque, len: c_int, strong: c_int) c_int;
pub extern fn ssh_get_version(session: ssh_session) c_int;
pub extern fn ssh_get_status(session: ssh_session) c_int;
pub extern fn ssh_get_poll_flags(session: ssh_session) c_int;
pub extern fn ssh_init() c_int;
pub extern fn ssh_is_blocking(session: ssh_session) c_int;
pub extern fn ssh_is_connected(session: ssh_session) c_int;
pub extern fn ssh_knownhosts_entry_free(entry: [*c]struct_ssh_knownhosts_entry) void;
pub extern fn ssh_known_hosts_parse_line(host: [*c]const u8, line: [*c]const u8, entry: [*c][*c]struct_ssh_knownhosts_entry) c_int;
pub extern fn ssh_session_has_known_hosts_entry(session: ssh_session) enum_ssh_known_hosts_e;
pub extern fn ssh_session_export_known_hosts_entry(session: ssh_session, pentry_string: [*c][*c]u8) c_int;
pub extern fn ssh_session_update_known_hosts(session: ssh_session) c_int;
pub extern fn ssh_session_get_known_hosts_entry(session: ssh_session, pentry: [*c][*c]struct_ssh_knownhosts_entry) enum_ssh_known_hosts_e;
pub extern fn ssh_session_is_known_server(session: ssh_session) enum_ssh_known_hosts_e;
pub extern fn ssh_set_log_level(level: c_int) c_int;
pub extern fn ssh_get_log_level() c_int;
pub extern fn ssh_get_log_userdata() ?*anyopaque;
pub extern fn ssh_set_log_userdata(data: ?*anyopaque) c_int;
pub extern fn ssh_vlog(verbosity: c_int, function: [*c]const u8, format: [*c]const u8, va: [*c]va_list) void;
pub extern fn _ssh_log(verbosity: c_int, function: [*c]const u8, format: [*c]const u8, ...) void;
pub extern fn ssh_log(session: ssh_session, prioriry: c_int, format: [*c]const u8, ...) void;
pub extern fn ssh_message_channel_request_open_reply_accept(msg: ssh_message) ssh_channel;
pub extern fn ssh_message_channel_request_open_reply_accept_channel(msg: ssh_message, chan: ssh_channel) c_int;
pub extern fn ssh_message_channel_request_reply_success(msg: ssh_message) c_int;
pub extern fn ssh_message_free(msg: ssh_message) void;
pub extern fn ssh_message_get(session: ssh_session) ssh_message;
pub extern fn ssh_message_subtype(msg: ssh_message) c_int;
pub extern fn ssh_message_type(msg: ssh_message) c_int;
pub extern fn ssh_mkdir(pathname: [*c]const u8, mode: mode_t) c_int;
pub extern fn ssh_new() ssh_session;
pub extern fn ssh_options_copy(src: ssh_session, dest: [*c]ssh_session) c_int;
pub extern fn ssh_options_getopt(session: ssh_session, argcptr: [*c]c_int, argv: [*c][*c]u8) c_int;
pub extern fn ssh_options_parse_config(session: ssh_session, filename: [*c]const u8) c_int;
pub extern fn ssh_options_set(session: ssh_session, @"type": enum_ssh_options_e, value: ?*const anyopaque) c_int;
pub extern fn ssh_options_get(session: ssh_session, @"type": enum_ssh_options_e, value: [*c][*c]u8) c_int;
pub extern fn ssh_options_get_port(session: ssh_session, port_target: [*c]c_uint) c_int;
pub extern fn ssh_pcap_file_close(pcap: ssh_pcap_file) c_int;
pub extern fn ssh_pcap_file_free(pcap: ssh_pcap_file) void;
pub extern fn ssh_pcap_file_new() ssh_pcap_file;
pub extern fn ssh_pcap_file_open(pcap: ssh_pcap_file, filename: [*c]const u8) c_int;
pub const ssh_auth_callback = ?*const fn ([*c]const u8, [*c]u8, usize, c_int, c_int, ?*anyopaque) callconv(.c) c_int;
pub const SSH_FILE_FORMAT_DEFAULT: c_int = 0;
pub const SSH_FILE_FORMAT_OPENSSH: c_int = 1;
pub const SSH_FILE_FORMAT_PEM: c_int = 2;
pub const enum_ssh_file_format_e = c_uint;
pub extern fn ssh_key_new() ssh_key;
pub extern fn ssh_key_free(key: ssh_key) void;
pub extern fn ssh_key_type(key: ssh_key) enum_ssh_keytypes_e;
pub extern fn ssh_key_type_to_char(@"type": enum_ssh_keytypes_e) [*c]const u8;
pub extern fn ssh_key_type_from_name(name: [*c]const u8) enum_ssh_keytypes_e;
pub extern fn ssh_key_is_public(k: ssh_key) c_int;
pub extern fn ssh_key_is_private(k: ssh_key) c_int;
pub extern fn ssh_key_cmp(k1: ssh_key, k2: ssh_key, what: enum_ssh_keycmp_e) c_int;
pub extern fn ssh_key_dup(key: ssh_key) ssh_key;
pub extern fn ssh_pki_generate(@"type": enum_ssh_keytypes_e, parameter: c_int, pkey: [*c]ssh_key) c_int;
pub extern fn ssh_pki_import_privkey_base64(b64_key: [*c]const u8, passphrase: [*c]const u8, auth_fn: ssh_auth_callback, auth_data: ?*anyopaque, pkey: [*c]ssh_key) c_int;
pub extern fn ssh_pki_export_privkey_base64(privkey: ssh_key, passphrase: [*c]const u8, auth_fn: ssh_auth_callback, auth_data: ?*anyopaque, b64_key: [*c][*c]u8) c_int;
pub extern fn ssh_pki_export_privkey_base64_format(privkey: ssh_key, passphrase: [*c]const u8, auth_fn: ssh_auth_callback, auth_data: ?*anyopaque, b64_key: [*c][*c]u8, format: enum_ssh_file_format_e) c_int;
pub extern fn ssh_pki_import_privkey_file(filename: [*c]const u8, passphrase: [*c]const u8, auth_fn: ssh_auth_callback, auth_data: ?*anyopaque, pkey: [*c]ssh_key) c_int;
pub extern fn ssh_pki_export_privkey_file(privkey: ssh_key, passphrase: [*c]const u8, auth_fn: ssh_auth_callback, auth_data: ?*anyopaque, filename: [*c]const u8) c_int;
pub extern fn ssh_pki_export_privkey_file_format(privkey: ssh_key, passphrase: [*c]const u8, auth_fn: ssh_auth_callback, auth_data: ?*anyopaque, filename: [*c]const u8, format: enum_ssh_file_format_e) c_int;
pub extern fn ssh_pki_copy_cert_to_privkey(cert_key: ssh_key, privkey: ssh_key) c_int;
pub extern fn ssh_pki_import_pubkey_base64(b64_key: [*c]const u8, @"type": enum_ssh_keytypes_e, pkey: [*c]ssh_key) c_int;
pub extern fn ssh_pki_import_pubkey_file(filename: [*c]const u8, pkey: [*c]ssh_key) c_int;
pub extern fn ssh_pki_import_cert_base64(b64_cert: [*c]const u8, @"type": enum_ssh_keytypes_e, pkey: [*c]ssh_key) c_int;
pub extern fn ssh_pki_import_cert_file(filename: [*c]const u8, pkey: [*c]ssh_key) c_int;
pub extern fn ssh_pki_export_privkey_to_pubkey(privkey: ssh_key, pkey: [*c]ssh_key) c_int;
pub extern fn ssh_pki_export_pubkey_base64(key: ssh_key, b64_key: [*c][*c]u8) c_int;
pub extern fn ssh_pki_export_pubkey_file(key: ssh_key, filename: [*c]const u8) c_int;
pub extern fn ssh_pki_key_ecdsa_name(key: ssh_key) [*c]const u8;
pub extern fn ssh_get_fingerprint_hash(@"type": enum_ssh_publickey_hash_type, hash: [*c]u8, len: usize) [*c]u8;
pub extern fn ssh_print_hash(@"type": enum_ssh_publickey_hash_type, hash: [*c]u8, len: usize) void;
pub extern fn ssh_send_ignore(session: ssh_session, data: [*c]const u8) c_int;
pub extern fn ssh_send_debug(session: ssh_session, message: [*c]const u8, always_display: c_int) c_int;
pub extern fn ssh_gssapi_set_creds(session: ssh_session, creds: ssh_gssapi_creds) void;
pub extern fn ssh_select(channels: [*c]ssh_channel, outchannels: [*c]ssh_channel, maxfd: socket_t, readfds: [*c]fd_set, timeout: [*c]struct_timeval) c_int;
pub extern fn ssh_service_request(session: ssh_session, service: [*c]const u8) c_int;
pub extern fn ssh_set_agent_channel(session: ssh_session, channel: ssh_channel) c_int;
pub extern fn ssh_set_agent_socket(session: ssh_session, fd: socket_t) c_int;
pub extern fn ssh_set_blocking(session: ssh_session, blocking: c_int) void;
pub extern fn ssh_set_counters(session: ssh_session, scounter: ssh_counter, rcounter: ssh_counter) void;
pub extern fn ssh_set_fd_except(session: ssh_session) void;
pub extern fn ssh_set_fd_toread(session: ssh_session) void;
pub extern fn ssh_set_fd_towrite(session: ssh_session) void;
pub extern fn ssh_silent_disconnect(session: ssh_session) void;
pub extern fn ssh_set_pcap_file(session: ssh_session, pcapfile: ssh_pcap_file) c_int;
pub extern fn ssh_userauth_none(session: ssh_session, username: [*c]const u8) c_int;
pub extern fn ssh_userauth_list(session: ssh_session, username: [*c]const u8) c_int;
pub extern fn ssh_userauth_try_publickey(session: ssh_session, username: [*c]const u8, pubkey: ssh_key) c_int;
pub extern fn ssh_userauth_publickey(session: ssh_session, username: [*c]const u8, privkey: ssh_key) c_int;
pub extern fn ssh_userauth_agent(session: ssh_session, username: [*c]const u8) c_int;
pub extern fn ssh_userauth_publickey_auto_get_current_identity(session: ssh_session, value: [*c][*c]u8) c_int;
pub extern fn ssh_userauth_publickey_auto(session: ssh_session, username: [*c]const u8, passphrase: [*c]const u8) c_int;
pub extern fn ssh_userauth_password(session: ssh_session, username: [*c]const u8, password: [*c]const u8) c_int;
pub extern fn ssh_userauth_kbdint(session: ssh_session, user: [*c]const u8, submethods: [*c]const u8) c_int;
pub extern fn ssh_userauth_kbdint_getinstruction(session: ssh_session) [*c]const u8;
pub extern fn ssh_userauth_kbdint_getname(session: ssh_session) [*c]const u8;
pub extern fn ssh_userauth_kbdint_getnprompts(session: ssh_session) c_int;
pub extern fn ssh_userauth_kbdint_getprompt(session: ssh_session, i: c_uint, echo: [*c]u8) [*c]const u8;
pub extern fn ssh_userauth_kbdint_getnanswers(session: ssh_session) c_int;
pub extern fn ssh_userauth_kbdint_getanswer(session: ssh_session, i: c_uint) [*c]const u8;
pub extern fn ssh_userauth_kbdint_setanswer(session: ssh_session, i: c_uint, answer: [*c]const u8) c_int;
pub extern fn ssh_userauth_gssapi(session: ssh_session) c_int;
pub extern fn ssh_version(req_version: c_int) [*c]const u8;
pub extern fn ssh_string_burn(str: ssh_string) void;
pub extern fn ssh_string_copy(str: ssh_string) ssh_string;
pub extern fn ssh_string_data(str: ssh_string) ?*anyopaque;
pub extern fn ssh_string_fill(str: ssh_string, data: ?*const anyopaque, len: usize) c_int;
pub extern fn ssh_string_free(str: ssh_string) void;
pub extern fn ssh_string_from_char(what: [*c]const u8) ssh_string;
pub extern fn ssh_string_len(str: ssh_string) usize;
pub extern fn ssh_string_new(size: usize) ssh_string;
pub extern fn ssh_string_get_char(str: ssh_string) [*c]const u8;
pub extern fn ssh_string_to_char(str: ssh_string) [*c]u8;
pub extern fn ssh_string_free_char(s: [*c]u8) void;
pub extern fn ssh_getpass(prompt: [*c]const u8, buf: [*c]u8, len: usize, echo: c_int, verify: c_int) c_int;
pub const ssh_event_callback = ?*const fn (socket_t, c_int, ?*anyopaque) callconv(.c) c_int;
pub extern fn ssh_event_new() ssh_event;
pub extern fn ssh_event_add_fd(event: ssh_event, fd: socket_t, events: c_short, cb: ssh_event_callback, userdata: ?*anyopaque) c_int;
pub extern fn ssh_event_add_session(event: ssh_event, session: ssh_session) c_int;
pub extern fn ssh_event_add_connector(event: ssh_event, connector: ssh_connector) c_int;
pub extern fn ssh_event_dopoll(event: ssh_event, timeout: c_int) c_int;
pub extern fn ssh_event_remove_fd(event: ssh_event, fd: socket_t) c_int;
pub extern fn ssh_event_remove_session(event: ssh_event, session: ssh_session) c_int;
pub extern fn ssh_event_remove_connector(event: ssh_event, connector: ssh_connector) c_int;
pub extern fn ssh_event_free(event: ssh_event) void;
pub extern fn ssh_get_clientbanner(session: ssh_session) [*c]const u8;
pub extern fn ssh_get_serverbanner(session: ssh_session) [*c]const u8;
pub extern fn ssh_get_kex_algo(session: ssh_session) [*c]const u8;
pub extern fn ssh_get_cipher_in(session: ssh_session) [*c]const u8;
pub extern fn ssh_get_cipher_out(session: ssh_session) [*c]const u8;
pub extern fn ssh_get_hmac_in(session: ssh_session) [*c]const u8;
pub extern fn ssh_get_hmac_out(session: ssh_session) [*c]const u8;
pub extern fn ssh_buffer_new() ssh_buffer;
pub extern fn ssh_buffer_free(buffer: ssh_buffer) void;
pub extern fn ssh_buffer_reinit(buffer: ssh_buffer) c_int;
pub extern fn ssh_buffer_add_data(buffer: ssh_buffer, data: ?*const anyopaque, len: u32) c_int;
pub extern fn ssh_buffer_get_data(buffer: ssh_buffer, data: ?*anyopaque, requestedlen: u32) u32;
pub extern fn ssh_buffer_get(buffer: ssh_buffer) ?*anyopaque;
pub extern fn ssh_buffer_get_len(buffer: ssh_buffer) u32;
pub extern fn ssh_session_set_disconnect_message(session: ssh_session, message: [*c]const u8) c_int;
pub const struct_ssh_private_key_struct = opaque {};
pub const ssh_private_key = ?*struct_ssh_private_key_struct;
pub const struct_ssh_public_key_struct = opaque {};
pub const ssh_public_key = ?*struct_ssh_public_key_struct;
pub extern fn ssh_auth_list(session: ssh_session) c_int;
pub extern fn ssh_userauth_offer_pubkey(session: ssh_session, username: [*c]const u8, @"type": c_int, publickey: ssh_string) c_int;
pub extern fn ssh_userauth_pubkey(session: ssh_session, username: [*c]const u8, publickey: ssh_string, privatekey: ssh_private_key) c_int;
pub extern fn ssh_userauth_agent_pubkey(session: ssh_session, username: [*c]const u8, publickey: ssh_public_key) c_int;
pub extern fn ssh_userauth_autopubkey(session: ssh_session, passphrase: [*c]const u8) c_int;
pub extern fn ssh_userauth_privatekey_file(session: ssh_session, username: [*c]const u8, filename: [*c]const u8, passphrase: [*c]const u8) c_int;
pub extern fn buffer_free(buffer: ssh_buffer) void;
pub extern fn buffer_get(buffer: ssh_buffer) ?*anyopaque;
pub extern fn buffer_get_len(buffer: ssh_buffer) u32;
pub extern fn buffer_new() ssh_buffer;
pub extern fn channel_accept_x11(channel: ssh_channel, timeout_ms: c_int) ssh_channel;
pub extern fn channel_change_pty_size(channel: ssh_channel, cols: c_int, rows: c_int) c_int;
pub extern fn channel_forward_accept(session: ssh_session, timeout_ms: c_int) ssh_channel;
pub extern fn channel_close(channel: ssh_channel) c_int;
pub extern fn channel_forward_cancel(session: ssh_session, address: [*c]const u8, port: c_int) c_int;
pub extern fn channel_forward_listen(session: ssh_session, address: [*c]const u8, port: c_int, bound_port: [*c]c_int) c_int;
pub extern fn channel_free(channel: ssh_channel) void;
pub extern fn channel_get_exit_status(channel: ssh_channel) c_int;
pub extern fn channel_get_session(channel: ssh_channel) ssh_session;
pub extern fn channel_is_closed(channel: ssh_channel) c_int;
pub extern fn channel_is_eof(channel: ssh_channel) c_int;
pub extern fn channel_is_open(channel: ssh_channel) c_int;
pub extern fn channel_new(session: ssh_session) ssh_channel;
pub extern fn channel_open_forward(channel: ssh_channel, remotehost: [*c]const u8, remoteport: c_int, sourcehost: [*c]const u8, localport: c_int) c_int;
pub extern fn channel_open_session(channel: ssh_channel) c_int;
pub extern fn channel_poll(channel: ssh_channel, is_stderr: c_int) c_int;
pub extern fn channel_read(channel: ssh_channel, dest: ?*anyopaque, count: u32, is_stderr: c_int) c_int;
pub extern fn channel_read_buffer(channel: ssh_channel, buffer: ssh_buffer, count: u32, is_stderr: c_int) c_int;
pub extern fn channel_read_nonblocking(channel: ssh_channel, dest: ?*anyopaque, count: u32, is_stderr: c_int) c_int;
pub extern fn channel_request_env(channel: ssh_channel, name: [*c]const u8, value: [*c]const u8) c_int;
pub extern fn channel_request_exec(channel: ssh_channel, cmd: [*c]const u8) c_int;
pub extern fn channel_request_pty(channel: ssh_channel) c_int;
pub extern fn channel_request_pty_size(channel: ssh_channel, term: [*c]const u8, cols: c_int, rows: c_int) c_int;
pub extern fn channel_request_shell(channel: ssh_channel) c_int;
pub extern fn channel_request_send_signal(channel: ssh_channel, signum: [*c]const u8) c_int;
pub extern fn channel_request_sftp(channel: ssh_channel) c_int;
pub extern fn channel_request_subsystem(channel: ssh_channel, subsystem: [*c]const u8) c_int;
pub extern fn channel_request_x11(channel: ssh_channel, single_connection: c_int, protocol: [*c]const u8, cookie: [*c]const u8, screen_number: c_int) c_int;
pub extern fn channel_send_eof(channel: ssh_channel) c_int;
pub extern fn channel_select(readchans: [*c]ssh_channel, writechans: [*c]ssh_channel, exceptchans: [*c]ssh_channel, timeout: [*c]struct_timeval) c_int;
pub extern fn channel_set_blocking(channel: ssh_channel, blocking: c_int) void;
pub extern fn channel_write(channel: ssh_channel, data: ?*const anyopaque, len: u32) c_int;
pub extern fn privatekey_free(prv: ssh_private_key) void;
pub extern fn privatekey_from_file(session: ssh_session, filename: [*c]const u8, @"type": c_int, passphrase: [*c]const u8) ssh_private_key;
pub extern fn publickey_free(key: ssh_public_key) void;
pub extern fn ssh_publickey_to_file(session: ssh_session, file: [*c]const u8, pubkey: ssh_string, @"type": c_int) c_int;
pub extern fn publickey_from_file(session: ssh_session, filename: [*c]const u8, @"type": [*c]c_int) ssh_string;
pub extern fn publickey_from_privatekey(prv: ssh_private_key) ssh_public_key;
pub extern fn publickey_to_string(key: ssh_public_key) ssh_string;
pub extern fn ssh_try_publickey_from_file(session: ssh_session, keyfile: [*c]const u8, publickey: [*c]ssh_string, @"type": [*c]c_int) c_int;
pub extern fn ssh_privatekey_type(privatekey: ssh_private_key) enum_ssh_keytypes_e;
pub extern fn ssh_get_pubkey(session: ssh_session) ssh_string;
pub extern fn ssh_message_retrieve(session: ssh_session, packettype: u32) ssh_message;
pub extern fn ssh_message_auth_publickey(msg: ssh_message) ssh_public_key;
pub extern fn string_burn(str: ssh_string) void;
pub extern fn string_copy(str: ssh_string) ssh_string;
pub extern fn string_data(str: ssh_string) ?*anyopaque;
pub extern fn string_fill(str: ssh_string, data: ?*const anyopaque, len: usize) c_int;
pub extern fn string_free(str: ssh_string) void;
pub extern fn string_from_char(what: [*c]const u8) ssh_string;
pub extern fn string_len(str: ssh_string) usize;
pub extern fn string_new(size: usize) ssh_string;
pub extern fn string_to_char(str: ssh_string) [*c]u8;
...
pub const _LIBSSH_H = "";
pub const _LIBSSH_VERSION_H = "";
pub inline fn SSH_VERSION_INT(a: anytype, b: anytype, c: anytype) @TypeOf(((a << @as(c_int, 16)) | (b << @as(c_int, 8))) | c) {
    _ = &a;
    _ = &b;
    _ = &c;
    return ((a << @as(c_int, 16)) | (b << @as(c_int, 8))) | c;
}
pub const SSH_VERSION_DOT = @compileError("unable to translate C expr: unexpected token '##'");
// /usr/include/libssh/libssh_version.h:26:9
pub inline fn SSH_VERSION(a: anytype, b: anytype, c: anytype) @TypeOf(SSH_VERSION_DOT(a, b, c)) {
    _ = &a;
    _ = &b;
    _ = &c;
    return SSH_VERSION_DOT(a, b, c);
}
pub const LIBSSH_VERSION_MAJOR = @as(c_int, 0);
pub const LIBSSH_VERSION_MINOR = @as(c_int, 11);
pub const LIBSSH_VERSION_MICRO = @as(c_int, 3);
pub const LIBSSH_VERSION_INT = SSH_VERSION_INT(LIBSSH_VERSION_MAJOR, LIBSSH_VERSION_MINOR, LIBSSH_VERSION_MICRO);
pub const LIBSSH_VERSION = SSH_VERSION(LIBSSH_VERSION_MAJOR, LIBSSH_VERSION_MINOR, LIBSSH_VERSION_MICRO);
pub const LIBSSH_API = @compileError("unable to translate macro: undefined identifier `visibility`");
// /usr/include/libssh/libssh.h:46:13
...
pub inline fn SSH_STRINGIFY(s: anytype) @TypeOf(SSH_TOSTRING(s)) {
    _ = &s;
    return SSH_TOSTRING(s);
}
pub const SSH_TOSTRING = @compileError("unable to translate C expr: unexpected token '#'");
// /usr/include/libssh/libssh.h:71:9
pub const PRINTF_ATTRIBUTE = @compileError("unable to translate macro: undefined identifier `__format__`");
// /usr/include/libssh/libssh.h:75:9
pub const SSH_DEPRECATED = @compileError("unable to translate macro: undefined identifier `deprecated`");
// /usr/include/libssh/libssh.h:81:9
pub const SSH_INVALID_SOCKET = @import("std").zig.c_translation.cast(socket_t, -@as(c_int, 1));
pub const SSH_CRYPT = @as(c_int, 2);
pub const SSH_MAC = @as(c_int, 3);
pub const SSH_COMP = @as(c_int, 4);
pub const SSH_LANG = @as(c_int, 5);
pub const SSH_AUTH_METHOD_UNKNOWN = @as(c_uint, 0x0000);
pub const SSH_AUTH_METHOD_NONE = @as(c_uint, 0x0001);
pub const SSH_AUTH_METHOD_PASSWORD = @as(c_uint, 0x0002);
pub const SSH_AUTH_METHOD_PUBLICKEY = @as(c_uint, 0x0004);
pub const SSH_AUTH_METHOD_HOSTBASED = @as(c_uint, 0x0008);
pub const SSH_AUTH_METHOD_INTERACTIVE = @as(c_uint, 0x0010);
pub const SSH_AUTH_METHOD_GSSAPI_MIC = @as(c_uint, 0x0020);
pub const SSH_CLOSED = @as(c_int, 0x01);
pub const SSH_READ_PENDING = @as(c_int, 0x02);
pub const SSH_CLOSED_ERROR = @as(c_int, 0x04);
pub const SSH_WRITE_PENDING = @as(c_int, 0x08);
pub const MD5_DIGEST_LEN = @as(c_int, 16);
pub const SSH_ADDRSTRLEN = @as(c_int, 46);
pub const SSH_OK = @as(c_int, 0);
pub const SSH_ERROR = -@as(c_int, 1);
pub const SSH_AGAIN = -@as(c_int, 2);
pub const SSH_EOF = -@as(c_int, 127);
pub const SSH_LOG_RARE = SSH_LOG_WARNING;
pub const SSH_LOG_NONE = @as(c_int, 0);
pub const SSH_LOG_WARN = @as(c_int, 1);
pub const SSH_LOG_INFO = @as(c_int, 2);
pub const SSH_LOG_DEBUG = @as(c_int, 3);
pub const SSH_LOG_TRACE = @as(c_int, 4);
pub const SSH_CHANNEL_FREE = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/libssh/libssh.h:459:9
pub const SSH_KNOWNHOSTS_ENTRY_FREE = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/libssh/libssh.h:617:9
pub const SSH_MESSAGE_FREE = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/libssh/libssh.h:658:9
pub const SSH_KEY_FREE = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/libssh/libssh.h:711:9
pub const SSH_STRING_FREE = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/libssh/libssh.h:842:9
pub const SSH_STRING_FREE_CHAR = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/libssh/libssh.h:850:9
pub const SSH_BUFFER_FREE = @compileError("unable to translate C expr: unexpected token 'do'");
// /usr/include/libssh/libssh.h:880:9
pub const LEGACY_H_ = "";
...
pub const ssh_counter_struct = struct_ssh_counter_struct;
pub const ssh_agent_struct = struct_ssh_agent_struct;
pub const ssh_buffer_struct = struct_ssh_buffer_struct;
pub const ssh_channel_struct = struct_ssh_channel_struct;
pub const ssh_message_struct = struct_ssh_message_struct;
pub const ssh_pcap_file_struct = struct_ssh_pcap_file_struct;
pub const ssh_key_struct = struct_ssh_key_struct;
pub const ssh_scp_struct = struct_ssh_scp_struct;
pub const ssh_session_struct = struct_ssh_session_struct;
pub const ssh_string_struct = struct_ssh_string_struct;
pub const ssh_event_struct = struct_ssh_event_struct;
pub const ssh_connector_struct = struct_ssh_connector_struct;
pub const ssh_kex_types_e = enum_ssh_kex_types_e;
pub const ssh_auth_e = enum_ssh_auth_e;
pub const ssh_requests_e = enum_ssh_requests_e;
pub const ssh_channel_type_e = enum_ssh_channel_type_e;
pub const ssh_channel_requests_e = enum_ssh_channel_requests_e;
pub const ssh_global_requests_e = enum_ssh_global_requests_e;
pub const ssh_publickey_state_e = enum_ssh_publickey_state_e;
pub const ssh_server_known_e = enum_ssh_server_known_e;
pub const ssh_known_hosts_e = enum_ssh_known_hosts_e;
pub const ssh_error_types_e = enum_ssh_error_types_e;
pub const ssh_keytypes_e = enum_ssh_keytypes_e;
pub const ssh_keycmp_e = enum_ssh_keycmp_e;
pub const ssh_knownhosts_entry = struct_ssh_knownhosts_entry;
pub const ssh_control_master_options_e = enum_ssh_control_master_options_e;
pub const ssh_options_e = enum_ssh_options_e;
pub const ssh_scp_request_types = enum_ssh_scp_request_types;
pub const ssh_connector_flags_e = enum_ssh_connector_flags_e;
pub const ssh_publickey_hash_type = enum_ssh_publickey_hash_type;
pub const ssh_file_format_e = enum_ssh_file_format_e;
pub const ssh_private_key_struct = struct_ssh_private_key_struct;
pub const ssh_public_key_struct = struct_ssh_public_key_struct;
